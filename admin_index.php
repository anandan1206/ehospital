...
<body>
  ...
  <header id="header" class="fixed-top">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <!-- <li><a class="nav-link scrollto" href="login.php">log in</a></li> -->
              ...
              <li class="dropdown"><a href="#"><span>approve</span> <i class="bi bi-chevron-down"></i></a>
    
              
              <ul>
              <li><a href="approve_doctor.php">doctor</a></li>
              <li><a href="leav requst.php">leave requst </a></li>
    ...
    <ul>
    <li><a href="addmedicine.php">add </a></li>
    <li><a href="edit_medicine.php">edit </a></li>
...
<li class="dropdown"><a href="#"><span>view</span> <i class="bi bi-chevron-down"></i></a>
    ...
    <ul>
    <li><a href="patient_view.php">view patient </a></li>
    <li><a href="view_complaint.php">feedback/complaint</a></li>
