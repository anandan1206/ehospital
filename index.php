  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="intex.php">home</a></li>
          ...
          <li class="dropdown"><a href="#"><span>registration</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="signup.php">Doctor</a></li>
                  <li><a href="patiant reg.php">patient</a></li>
