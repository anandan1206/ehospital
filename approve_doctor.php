...
<h2 class="mb-2 title-color" style="color:black">Approve Doctors</h2>
          ...
          <!--  <div class="table-responsive"-->
                ...
                ?>
                       <tr>
                           ...
                           <td><input type="text" value="<?php echo $row['phn_no']; ?>" ></td>
                           <td><input type="text"  value="<?php echo $row['dob']; ?>" ></td>
                           <td><input type="text"  value="<?php echo $row['adress']; ?>" ></td>
