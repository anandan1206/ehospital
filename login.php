...
if(isset($_POST ['submit']))
{
  ...
  // var_dump($type);exit();
  $query=mysqli_query($conn,"SELECT * FROM login_table WHERE type='$type' and username='$username' and password='$password'");
      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 form-group">
              <select class="form-control" name="type" id="exampleformcontrolselect">
        ...
        <div class="row">
            <div class="col-md-4 form-group">
              <input type="text" name="username" required="" class="form-control" id="username" placeholder="username" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
